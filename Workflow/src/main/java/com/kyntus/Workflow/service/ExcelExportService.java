...
public class ExcelExportService {
    ...
    public ByteArrayInputStream exportTasksToExcel(Long templateId) {
        ...
        if (tasks.isEmpty()) {
            // Optionnel : Tu peux retourner un Excel vide ou lancer une erreur
            // Pour l'instant, on lance une erreur pour que tu saches qu'il n'y a rien à exporter
        ...
        try (Workbook workbook = new XSSFWorkbook();
            ...
            cellEps.setCellValue("Référence EPS"); // Ou le nom original si tu l'as stocké
